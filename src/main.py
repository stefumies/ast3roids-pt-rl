...
from sprites import Player, Lazer, Meteor
...
class Game:
    def __init__(self):
        ...
        self.lazers = []
        self.meteors = []
        self.meteor_timer = Timer(METEOR_TIMER_DURATION, True, True, self.spawn_meteor)
    ...
    def spawn_meteor(self):
        self.meteors.append(Meteor(self.textures.get("meteor")))
